            ...
            <nav class="relative max-w-7xl w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
                ...
                <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
                    <div class="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:pl-7">
                        <Link className={` text-xl text-black hover:text-gray-400 sm:py-6 dark:text-gray-400 dark:hover:text-gray-500 ${router.pathname === '/' ? 'font-bold' : ''}`} href="/">
                            Acerca de mi
                        </Link>
                        <Link
                            className={`text-xl text-black hover:text-gray-400 sm:py-6 dark:text-gray-400 dark:hover:text-gray-500 ${router.pathname === '/proyectos' ? 'font-bold' : ''}`} href="/proyectos">
                            Proyectos
                        </Link>
                        <Link
                            className={`text-xl text-black hover:text-gray-400 sm:py-6 dark:text-gray-400 dark:hover:text-gray-500 ${router.pathname === '/habilidades' ? 'font-bold' : ''}`} href="/habilidades">
                            Habilidades
                        </Link>
                        <Link class={`text-xl text-black hover:text-gray-400 sm:py-6 dark:text-gray-400 dark:hover:text-gray-500 ${router.pathname === '/contacto' ? 'font-bold' : ''}`} href="/contacto">
                            Contacto
                        </Link>
                    </div>
                </div>
